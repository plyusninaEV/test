...
# 3. Настройка рабочей среды <a name="Настройкарабочейсреды"></a>
...
# 4. Клонирование репозитория на компьютер <a name="Клонированиерепозиториянакомпьютер"></a>
...
# 5. Загрузка файлов в репозиторий <a name="Загрузкафайловврепозиторий"></a>
...
# 6. Создание веток <a name="Созданиеветок"></a>
