...
7. [Совместная разработка в команде](#Совместнаяразработкавкоманде)
          1.[Создание Pull Request](#PullRequest)
9. [Деплой на gh-pages]
10. [Деплой на netlify]
11. [Приватный репозиторий]
12. [Игнорирование файлов](#Игнорированиефайлов)
13. [Команды Git](#КомандыGit)
14. [Команды в GitBash консоли](#КомандыGitBash)
15. [Примеры](#Примеры)
...
# Совместная разработка в команде  <a name="Совместнаяразработкавкоманде"></a>
        ## Создание Pull Request <a name="PullRequest"></a>
...
```
# Команды в GitBash консоли <a name="КомандыGitBash"></a>
